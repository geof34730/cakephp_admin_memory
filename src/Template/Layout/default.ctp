...
<head>
    ...
    <script type="text/javascript">
        ...
        if(!empty($session->read('idrefA'))){
            $session->delete('idrefA');
            ?>
        sessionStorage['idlecA'] = 'ok';
        <?php
        }
        ?>
        if (sessionStorage['idlecA'] == undefined) {
            <?php
...
<?php echo $this->Html->script('/js/iovation.js'); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.saveformloading').on('click', function() {
            var $this = $(this);
            $this.button('loading');
        });
    });
